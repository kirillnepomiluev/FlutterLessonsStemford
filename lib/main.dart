  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        //       /// Виджет Expanded() позволяет распределять свободное
        ...
        body: Container(
          ...
          child: Column(
            /// Виджет Row позволяет располагать несколько виджетов в колонку. Высота колонки определяется свободным пространством на экране,
            ...
            /// Свойство, отвечающее за расположение виджетов на главной оси. Принимает в себя
            /// конструкторы MainAxisAlignment.

            crossAxisAlignment: CrossAxisAlignment.center,

            /// Свойство, отвечающее за расположение виджетов на побочной оси. Принимает в себя
            /// конструкторы CrossAxisAlignment.
              ...
              Expanded( flex: 2,
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(
                      // Этот тип градиента является радиальным.
                      begin: Alignment.topLeft,
                      end: Alignment.bottomRight,
                      colors: [
                        Colors.teal,

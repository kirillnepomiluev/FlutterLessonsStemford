    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: Container(
          ...
          width: 200, // Свойство, отвечающее за ширину контейнера. Принимает в себя
          // вещественное число.
          ...
          decoration: const BoxDecoration( // Свойство, отвечающее за стилизацию контейнера.
            // Принимает в себя виджет BoxDecoration().

            boxShadow: [BoxShadow( // Свойство, отвечающее за добавление теней объекту.
              // Принимает в себя виджеты BoxShadow().

              color: Colors.black, // Свойство, отвечающее за цвет тени

              blurRadius: 5, // Свойство, задающее радиус размытия тени. Принимает в себя
              // вецественное число.

              offset: Offset(5, 5), // Свойство, отвечающее за смещение тени относительно
            ...
            gradient: LinearGradient( /// Свойство, отвечающее за нанесение градиента
              ...
              begin: Alignment.centerLeft, // Свойство, указывающее начало градиента.
              // Принимает в себя конструктор Alignment.

              end: Alignment.centerRight, // Свойство, указывающее конец градиента.
              // Принимает в себя конструктор Alignment.

              colors: [ // Свойство, принимающие в себя перечень цветов. Цвета располагаются
                // слева направо.
            ...
            Border( // Свойство, добавляющее контуйнеру рамку. Принимает в себя
              // виджет Border().

              bottom: BorderSide( // Свойство, отвечающее за нижнюю границу контейнера.
                // Принимает в себя виджет BorderSide().

                width: 4, // Свойство, отвечающее за толщину рамки. Принимает в себя
                // вещественное число.

                color: Colors.black, // Свойство, отвечающее за цвет рамки.
                // Принимает в себя виджет Color().
        ...
        //       ],
        //     ),
        //     borderRadius: BorderRadius.circular(30), // Скругление углов контейнера

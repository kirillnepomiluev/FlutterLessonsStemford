  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        // body: RichText( /// В предыдущем примере мы научились декорировать текст.
        ...
        //
        //   text: TextSpan(// Свойство, в которое помещается виджет TextSpan(),
        ...
        //     ),
        //     children: [ /// Свойство children содержит в себе дочерние виджеты.
        //     При этом дочерние виджеты помещаются в квадратные скобки.
        //       /// Теперь внутрь свойства children мы передадим еще несколько
        //       вилдетов TextSpan(), в которых будут содержаться отдельные
        ...
        //
        //         text: "Hello ", // Здесь в свойство text мы уже передаем
        ...
        //         fontSize: 35, decoration: TextDecoration.none), /// Изменим цвет
